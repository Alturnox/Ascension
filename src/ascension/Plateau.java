...
//        public Cards(String nom, int effet, String type, int runes, int attaque, String description, int recompense) {
            ...
            Cards arhaInitiate1= new Cards("Arha Initiate", 1,"Héros",1,0,"Nellin observed the whirling movements of the initiates. \"Are they practicing forms ? \" he asked. \" No, \" came the intructor's reply.\"They are meditating. \"",1);
            Cards arhaInitiate2= new Cards("Arha Initiate", 1,"Héros",1,0,"Nellin observed the whirling movements of the initiates. \"Are they practicing forms ? \" he asked. \" No, \" came the intructor's reply.\"They are meditating. \"",1);
            Cards arhaInitiate3= new Cards("Arha Initiate", 1,"Héros",1,0,"Nellin observed the whirling movements of the initiates. \"Are they practicing forms ? \" he asked. \" No, \" came the intructor's reply.\"They are meditating. \"",1);
